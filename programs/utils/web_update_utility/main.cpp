...
int main()
{
    ...
    cout << "Welcome to the NameShares Web Update Utility. This tool is not particularly well-written. This tool is not user friendly. It is not for users. It is for developers. Deal with it.\n\nWould you like to (p)repare a new update, or (s)ign an existing one? ";
    cin >> option;
